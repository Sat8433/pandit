...
<head>
    ...
    <title>Create Samagri - Admin Dashboard</title>
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Create Samagri Item</h1>
        </div>

        <form action="{{ route('admin.samagri.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Unit of Measurement (kg, pack, piece) <span class="text-red-500">*</span></label>
                    <input type="text" name="unit" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500">
                </div>
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Price Per Unit (₹) <span class="text-red-500">*</span></label>
                <input type="number" step="0.01" name="price_per_unit" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                <textarea name="description" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500"></textarea>
            </div>
            ...
            <div class="flex justify-between pt-4 border-t">
                ...
                <button type="submit" class="bg-purple-600 text-white px-6 py-2 rounded-md font-medium hover:bg-purple-700">Save Item</button>
            </div>
        </form>
    </div>
</body>
